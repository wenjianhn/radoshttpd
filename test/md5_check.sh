...
echo "check all data"
curl http://127.0.0.1:3000/md5sum/video/newoid
md5sum file

sleep 1
echo "check first 10M"
curl -H"Range:bytes 0-$end" http://127.0.0.1:3000/md5sum/video/newoid
dd if=file bs=1M count=10| md5sum -

sleep 1
echo "check last 6M"
curl -H"Range:bytes 10485760-16777215" http://127.0.0.1:3000/md5sum/video/newoid
